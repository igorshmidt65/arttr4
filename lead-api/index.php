...
<body>
<h4 style="text-align: center;">Установка глобального оффера</h4>
<div class="container mt-3">
	<h4 style="text-align: center;">Выбери ПП</h4>
	<form action="" method="post">
		<div class="row justify-content-center form-row">
			<div class="col-4">
				<select class="form-control" id="pp" name="pp">
					<option id="first-pp">MonsterLeads</option>
					<option>BroLeads</option>
                    <option>Adcombo</option>
                    <option>Affbay</option>
                    <option>KMA</option>
					<option>TerraLeads</option>
					<option>Lead-R</option>
					<option>LeadRock</option>
					<option>Magichygeia</option>
					<option>Aff1</option>
					<option>CPAGetti</option>
                    <option>LuckyOnline</option>
                    <option>Everad</option>
                    <option>Worldfilia</option>
                    <option>RocketProfit</option>
                    <option>LeadBit</option>
                    <option>Ikon</option>
                    <option>DrCash</option>
                    <option>LeadReaktor</option>
                    <option>LeadReaktor.lat</option>
                </select>
				<label class="font-weight-bold">Введи код потока</label>
				<input class="input-group" name="stream" type="text" value="">
                <label class="font-weight-bold">Введи Ленд</label>
                <input class="input-group" name="other" type="text" value="">
                <label class="font-weight-bold">Введи ГЕО</label>
                <input class="input-group" name="geo" type="text" value="">
                <label class="font-weight-bold">Введи язык</label>
                <input class="input-group" name="lang" type="text" value="">
                <label class="font-weight-bold">Введи цену за лид</label>
                <input class="input-group" name="pay" type="text" value="">
			</div>
		</div>
		<div class="row justify-content-center form-row">
			<div class="col-4">
